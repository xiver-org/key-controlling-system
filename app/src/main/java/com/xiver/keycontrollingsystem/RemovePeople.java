...
public class RemovePeople extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remove_people);
        ...
        if (keys.equals("[]")) {
            Toast.makeText(this, "В базе нет людей!", Toast.LENGTH_SHORT)
                    .show();
        ...
        spinner.setPrompt("Выберите человека");
    }
